...
# our part
COPY --from=builder /tmp/build/include /opt/eosio/include
COPY --from=builder /usr/local/include /opt/eosio/include
COPY --from=builder /eos/contracts /opt/eosio/include
COPY --from=builder /opt/wasm /opt/wasm
COPY --from=builder /tmp/build/usr /opt/eosio/usr
